...
echo "    Desktop id: ${APPIMAGE_DESKTOP_ID} (Name=ReplayBox). If appimage-manager still"
echo "    shows the old name/icon (e.g. Icon=replaybox or a blank icon), clear host caches"
echo "    and re-integrate:"
echo "      rm -f ~/.local/share/icons/hicolor/*/apps/appimage-*.png"
echo "      rm -f ~/.local/share/icons/hicolor/scalable/apps/appimage-*.svg"
echo "      rm -rf ~/.cache/thumbnails/*"
echo "    then remove/re-add the AppImage (see docs/BUILD.md)."
